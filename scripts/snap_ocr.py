...
from ocr_camera import clean_text, load_image, parse_roi, preprocess, rotate_frame
...
def main() -> int:
    ...
    # Get image: either from --image or by capturing a new one
    if args.image:
    ...
    if args.llm:
        # Vision LLM mode — send image directly to Ollama
